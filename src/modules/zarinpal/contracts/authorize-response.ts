const authorizeResCode = require('./payment-request-response-codes.contract');
 ...
 */
export function authorizeResponse(resCode) {
    let result = null;
